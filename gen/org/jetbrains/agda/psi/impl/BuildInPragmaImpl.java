...
public class BuildInPragmaImpl extends ASTWrapperPsiElement implements BuildInPragma {

  public BuildInPragmaImpl(ASTNode node) {
    super(node);
  }
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof Visitor) ((Visitor)visitor).visitBuildInPragma(this);
